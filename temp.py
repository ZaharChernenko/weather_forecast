...
"}")
        ...
        self.scroll_area_widget.setGeometry(QtCore.QRect(0, 0, 235, 620))
...
"}")
        ...
        self.main_page_scroll_widget.setGeometry(QtCore.QRect(0, 0, 560, 418))
...
"}")
        ...
        self.hourly_scroll_area_hlayout.setContentsMargins(0, 0, 0, 9)
        ...
        self.daily_widget = QtWidgets.QWidget(self.main_page_scroll_widget)
        self.daily_widget.setMinimumSize(QtCore.QSize(0, 50))
        self.daily_widget.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.daily_widget.setStyleSheet("#daily_widget{\n"
"    background: rgba(255, 255, 255, 64);\n"
"    border-radius: 10px;\n"
"}")
        self.daily_widget.setObjectName("daily_widget")
        self.daily_vlayout = QtWidgets.QVBoxLayout(self.daily_widget)
        ...
        self.daily_frame = QtWidgets.QFrame(self.daily_widget)
        self.daily_frame.setMinimumSize(QtCore.QSize(0, 30))
        self.daily_frame.setMaximumSize(QtCore.QSize(16777215, 30))
        ...
        self.daily_frame_hlayout = QtWidgets.QHBoxLayout(self.daily_frame)
        ...
        self.label = QtWidgets.QLabel(self.daily_frame)
        self.label.setMinimumSize(QtCore.QSize(15, 16))
        self.label.setMaximumSize(QtCore.QSize(15, 16))
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("icons/calendar_icon.svg"))
        self.label.setScaledContents(True)
        self.label.setObjectName("label")
        self.daily_frame_hlayout.addWidget(self.label)
        self.label_2 = QtWidgets.QLabel(self.daily_frame)
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.daily_main_frame = QtWidgets.QFrame(self.daily_widget)
        self.daily_main_frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.daily_main_frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.daily_main_frame.setObjectName("daily_main_frame")
        self.daily_main_frame_vlayout = QtWidgets.QVBoxLayout(self.daily_main_frame)
        ...
        self.daily_element = QtWidgets.QFrame(self.daily_main_frame)
        self.daily_element.setMinimumSize(QtCore.QSize(0, 40))
        self.daily_element.setMaximumSize(QtCore.QSize(16777215, 40))
        self.daily_element.setStyleSheet("#daily_element{\n"
"    border-top: 1px solid #d5d6d7;\n"
"}")
        self.daily_element.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.daily_element.setFrameShadow(QtWidgets.QFrame.Raised)
        self.daily_element.setObjectName("daily_element")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.daily_element)
        self.horizontalLayout.setContentsMargins(9, 0, 0, 0)
        self.horizontalLayout.setSpacing(0)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.daily_date = QtWidgets.QLabel(self.daily_element)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.daily_date.sizePolicy().hasHeightForWidth())
        self.daily_date.setSizePolicy(sizePolicy)
        self.daily_date.setMinimumSize(QtCore.QSize(35, 0))
        self.daily_date.setMaximumSize(QtCore.QSize(35, 16777215))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.daily_date.setFont(font)
        self.daily_date.setObjectName("daily_date")
        self.horizontalLayout.addWidget(self.daily_date)
        self.weather_label_2 = QtWidgets.QLabel(self.daily_element)
        self.weather_label_2.setMinimumSize(QtCore.QSize(40, 40))
        self.weather_label_2.setMaximumSize(QtCore.QSize(40, 40))
        self.weather_label_2.setText("")
        self.weather_label_2.setPixmap(QtGui.QPixmap("icons/01d.png"))
        self.weather_label_2.setScaledContents(True)
        self.weather_label_2.setObjectName("weather_label_2")
        self.horizontalLayout.addWidget(self.weather_label_2)
        self.temp_label_2 = QtWidgets.QLabel(self.daily_element)
        font = QtGui.QFont()
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "Прогноз на 8 дней:"))
        self.daily_date.setText(_translate("MainWindow", "31"))
        self.temp_label_2.setText(_translate("MainWindow", "Средняя: 25° | Мин: 21° | Макс: 29°"))
